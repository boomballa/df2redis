...
<!-- 🖼️ Replication Protocol Sequence Diagram Placeholder -->
<!-- Replace with: docs/images/architecture/replication-protocol.png -->
![Replication Protocol](../../images/architecture/replication-protocol.png)
